...
if __name__ == '__main__':
    ...
    persona1 = Persona(id_persona=1, nombre='Juan Carlos', apellido= 'Escobar', email='jescobar@gmail.com')
    ...
    '''
    # Insertar Personas
    persona1 = Persona(nombre='Pedro', apellido='Nagera', email='pnagera@gmail.com')
